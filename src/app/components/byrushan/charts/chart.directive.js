        ...
        .directive('sparklineBar', function(){
            ...
            return {
                ...
                link: function(scope, element) {
                    ...
                    sparkLineBar(element, scope.sparklineBar, '45px', 3, '#fff', 2);
//                    sparkLineBar(element, [6,4,8,6,5,6,7,8,3,5,9,5,8,4,3,6,8], '45px', 3, '#fff', 2);
//                    sparkLineBar(element, [4,7,6,2,5,3,8,6,6,4,8,6,5,8,2,4,6], '45px', 3, '#fff', 2);
                }
            }
        })
        ...
        .directive('sparklineLine', function(){
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    attrs.with = attrs.with || 85;
                    sparkLineLine(element, scope.sparklineLine, attrs.with, 45, '#fff', 'rgba(0,0,0,0)', 1.25, 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 3, '#fff', 'rgba(255,255,255,0.4)');
